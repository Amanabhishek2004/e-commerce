...
def update_user(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Redirect to a success page after updating the user
            

  
    return render(request, 'user_update.html', {'form': form, "page": page,"customer":Customer})
...
def delete_user(request):
    ...
    return render(request, "delete.html", {"user": user_to_be_delted, "page": page})
